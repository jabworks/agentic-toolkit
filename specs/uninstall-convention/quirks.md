...
## The flag survives every uninstall, on purpose
...
## `.bak` is not a rollback point after the second install
...
## Re-running uninstall must be boring
...
## A missing delegate is not an error
...
## Codex Desktop and absolute paths
