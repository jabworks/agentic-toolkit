...
## vercel-labs/skills #421 — global installs may not load (open upstream)
...
## Cursor imports the Claude Code plugin ecosystem — including stale clones
...
## Host-feature gaps (absent by design)
