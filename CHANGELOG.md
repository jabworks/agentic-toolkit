...
- chore: resanitize the 2026-09-08 specimen; close #80 (PR stamps) and #81 (task-brief heading) — condux 2.31.1 (#157)
...
- feat(blueprint): routing rules + collision gate for diagrams — close #77 (2.29.0) (#150)

## condux 2.28.0 — 2026-09-01

- feat(condux): OpenCode routing rides a synthetic chat.message reminder and names the skill tool — close #72 (2.28.0) (#147)
...
- chore(toolkit-ops): close #70 — change-control rows for plugin-level surfaces (#139)

## toolkit-ops 1.7.15 — 2026-08-29

- chore(toolkit-ops): close #69 — nudge remedy declined, diagnosis kept (#138)
...
- feat(discovery,blueprint): cite artifact paths, never relative links (#59 interim)
...
- feat(plan-review): the manuscript surface (D10) (#106)
